      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="grid lg:grid-cols-2 gap-4">
          <Card className="glass-card border-border/50">
            <CardHeader className="pb-2"><CardTitle className="text-sm font-semibold">Upcoming</CardTitle></CardHeader>
          ...
          <Card className="glass-card border-border/50">
            <CardHeader className="pb-2"><CardTitle className="text-sm font-semibold">Past Visits</CardTitle></CardHeader>
            <CardContent className="space-y-3">
              {past.map(visit => (
                <div key={visit.id} onClick={() => navigate(`/leads/${visit.leadId}`)}
